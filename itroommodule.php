...
class Itroommodule extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->version = '1.0.0';
        $this->author = 'Mathieu Vandenbussche';
        ...
        $this->description = $this->l('Module réalisé dans le cadre de tests techniques It-Room');
    ...
    {
        Configuration::updateValue('ITROOMMODULE_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('ITROOMMODULE_LIVE_MODE');
